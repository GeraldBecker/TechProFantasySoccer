...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <FooterTemplate>
            <tr>
                <td class="outstanding" colspan="16" style="text-align:center;">
                    ...
                    <asp:Button id="DeleteButton" Text="Delete Checked Fields" OnClick="DeleteButton_Click" runat="server"
                        style="background-color:#ffb2b2; height:50px; width:200px;"/>
                </td>
            </tr>
            </table>
        </FooterTemplate>
    ...
    <asp:Button id="GetPlayersButton" Text="Get Players" OnClick="GetPlayersButton_Click" 
        runat="server" style="background-color:#99ffa9; height:50px; width:200px;"/>
    <br />
